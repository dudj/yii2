...
-- ----------------------------
INSERT INTO `auth_assignment` VALUES ('报名管理', '1', '1477987306');
INSERT INTO `auth_assignment` VALUES ('权限控制', '1', '1477982148');
...
-- ----------------------------
INSERT INTO `auth_item` VALUES ('/admin/assignment/*', '2', null, null, null, '1477909797', '1477909797');
INSERT INTO `auth_item` VALUES ('/admin/assignment/index', '2', null, null, null, '1477909797', '1477909797');
INSERT INTO `auth_item` VALUES ('/admin/menu/*', '2', null, null, null, '1477909797', '1477909797');
INSERT INTO `auth_item` VALUES ('/admin/menu/index', '2', null, null, null, '1477909797', '1477909797');
INSERT INTO `auth_item` VALUES ('/admin/permission/*', '2', null, null, null, '1477909797', '1477909797');
INSERT INTO `auth_item` VALUES ('/admin/permission/index', '2', null, null, null, '1477909797', '1477909797');
INSERT INTO `auth_item` VALUES ('/admin/role/*', '2', null, null, null, '1477909797', '1477909797');
INSERT INTO `auth_item` VALUES ('/admin/role/index', '2', null, null, null, '1477909797', '1477909797');
INSERT INTO `auth_item` VALUES ('/admin/route/*', '2', null, null, null, '1477909797', '1477909797');
INSERT INTO `auth_item` VALUES ('/admin/route/index', '2', null, null, null, '1477909797', '1477909797');
INSERT INTO `auth_item` VALUES ('/info/*', '2', null, null, null, '1477986107', '1477986107');
INSERT INTO `auth_item` VALUES ('/info/index', '2', null, null, null, '1477986107', '1477986107');
INSERT INTO `auth_item` VALUES ('/info/regioninfo', '2', null, null, null, '1477994093', '1477994093');
INSERT INTO `auth_item` VALUES ('/recharge/*', '2', null, null, null, '1478093883', '1478093883');
INSERT INTO `auth_item` VALUES ('报名管理', '2', null, null, 'a:2:{s:4:\"icon\";s:12:\"fa fa-arrows\";s:7:\"visible\";b:1;}', '1477987258', '1477987258');
INSERT INTO `auth_item` VALUES ('权限控制', '2', null, null, null, '1477909841', '1477909841');
...
INSERT INTO `auth_item_child` VALUES ('报名管理', '/info/*');
INSERT INTO `auth_item_child` VALUES ('报名管理', '/info/index');
...
CREATE TABLE `info` (
  ...
  `provinceid` mediumint(8) DEFAULT NULL COMMENT '省份id',
  `cityid` mediumint(8) DEFAULT NULL COMMENT '城市id',
  `distinctid` mediumint(8) DEFAULT NULL COMMENT '区域id',
  PRIMARY KEY (`id`)
...
-- Records of info
-- ----------------------------
INSERT INTO `info` VALUES ('1', '杜栋江', '13020078873', null, '2', '52', '502');
...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES ('1', '权限控制', null, null, null, 0x7B2269636F6E223A2266612066612D6C6F636B222C2276697369626C65223A747275657D);
...
INSERT INTO `menu` VALUES ('7', '报名管理', null, null, '2', 0x7B2269636F6E223A2266612066612D6172726F7773222C2276697369626C65223A747275657D);
INSERT INTO `menu` VALUES ('8', '报名列表', '7', '/info/index', null, null);
...
-- ----------------------------
-- Table structure for signusers
-- ----------------------------
DROP TABLE IF EXISTS `signusers`;
CREATE TABLE `signusers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sign_id` int(11) NOT NULL COMMENT '报名表ID',
  `name` varchar(20) NOT NULL COMMENT '报名人',
  `iphone` varchar(20) NOT NULL COMMENT '电话',
  `session_userid` int(11) NOT NULL COMMENT '报名用户ID',
  `add_time` varchar(20) NOT NULL COMMENT '报名时间',
  `ziduan1` varchar(200) DEFAULT NULL COMMENT '可用字段1',
  `ziduan1_value` varchar(200) DEFAULT NULL COMMENT '可用字段2值',
  `ziduan2` varchar(200) DEFAULT NULL,
  `ziduan2_value` varchar(200) DEFAULT NULL,
  `ziduan3` varchar(200) DEFAULT NULL,
  `ziduan3_value` varchar(200) DEFAULT NULL,
  `session_username` varchar(100) NOT NULL COMMENT '注册用户名称',
  `session_useriphone` varchar(100) NOT NULL COMMENT '注册用户电话',
  `is_jiaofei` varchar(10) NOT NULL COMMENT '是否缴费',
  `jiaofei` double NOT NULL DEFAULT '0' COMMENT '缴费金额',
  `order_number` varchar(100) NOT NULL COMMENT '订单编号',
  `status` tinyint(4) DEFAULT '0' COMMENT '用户状态 0正常1 退出',
  `result` tinyint(4) DEFAULT '0' COMMENT '退订状态0默认1退订中2成功，3驳回 ',
  `wx_order` varchar(200) DEFAULT NULL COMMENT '微信订单号',
  `pay_jine` double DEFAULT '0' COMMENT '已经付款金额',
  `tuiding_time` varchar(20) DEFAULT NULL COMMENT '提交退订时间',
  `shenhe_time` varchar(20) DEFAULT NULL COMMENT '审核时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='活动报名人表';

-- ----------------------------
-- Records of signusers
-- ----------------------------
INSERT INTO `signusers` VALUES ('1', '6', '赵宝利', '13910768635', '5', '2016-10-28 14:44:46', '', '', '', '', '', '', '通天塔', '13910768635', '否', '0', '2016102814444655397', '0', '0', '', '0', '', '');
INSERT INTO `signusers` VALUES ('2', '7', '赵三', '13910768635', '5', '2016-10-31 11:34:24', '', '', '', '', '', '', '通天塔', '13910768635', '否', '0', '2016103111342452000', '0', '0', '', '0', '', '');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'admin', 'vf_sr35_zqudLHMV2MBFfsXpDq1EeDRc', '$2y$13$BOa8lBsp2408aJmPJVWzDu2qeQpnA67pxn76wuaIW7qDGeRwZoUK6', null, 'admin@163.com', '10', '1477909573', '1477909573');
